...
class NorthfieldQuilt extends Component {
constructor(props) {
  super(props);
  this.state = { 
    width: 0, 
...
render() {
  ...
  const { image_url, audio_url, age, statement, translation, embroiderer, main_text, main_font, id} = this.state.popUpInfo;
  ...
  if (this.state.width > 700){
    return(
      ...
      {/* { this.state.showMainPage === true ? 
                  <DescriptionPageNorthfield onClick1={ this.hideMainPage } onClick2={ this.showReadMore } height={this.state.height}/>
        : null}  */}
        <div className='main-container'>
          <div className='blue-line'></div>
          <div className='main-title-div'>
          <Link className='link-align' to="/"> <span className="material-symbols-outlined home-icon">home</span></Link>
             
              {/* <span class="material-symbols-outlined before-icon">navigate_before</span> */}
              ...
              <span></span>
                ...
                <div className="top-container">
                      ...
                      <Rectangle key={picture.id} height={rectangles_measuments[picture.id].height} onClick={() => this.activePopUp(picture.id)}  image_url={picture.image_url} id={picture.id} quilt={"northfield"}/>))}
                ...
                <div className='main-container-grid'>
                    <div className="left-container">
                      ...
                      <Rectangle key={picture.id} height={'90'} onClick={() => this.activePopUp(picture.id)}  image_url={picture.image_url} id={picture.id} quilt={"northfield"}/>))}
        ...
        <div className="pop-up-container" onClick={this.hidePopUp}>
          <PopUp onClick={this.handleClickChildElement}  image_url={image_url} audio_url={audio_url} translation={translation} statement={statement}  age={age} main_text={main_text} embroiderer={embroiderer} main_font={main_font} id={id} quilt={"northfield"}/>
        </div>
        : null}
      </div>
    );
      ...
      <div className='main-container-phone'>
        <div className='main-sub-container-phone'>
          ...
          <div className='first-container-grid-phone'>
            ...
            <Rectangle key={picture.id} height={90} onClick={() => this.activePopUp(picture.id)}  image_url={picture.image_url} id={picture.id} phone={true} quilt={"northfield"}/> ))}
          </div>
          ...
          <div className='first-container-grid-phone'>
            ...
            <Rectangle key={picture.id} height={80} onClick={() => this.activePopUp(picture.id)}  image_url={picture.image_url} id={picture.id} phone={true} quilt={"northfield"}/>))}
          </div>
          ...
          <div className='first-container-grid-phone'>
            ...
            <Rectangle key={picture.id} height={70} onClick={() => this.activePopUp(picture.id)}  image_url={picture.image_url} id={picture.id} phone={true} quilt={"northfield"}/>))}
          </div>
...
export default NorthfieldQuilt;
